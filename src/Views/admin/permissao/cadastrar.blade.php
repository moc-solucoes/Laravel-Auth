...
@section('content')
    ...
    <form class="form-material" action="{{route('auth.admin.usuario.permissao.cadastrar')}}" method="post">
        @csrf
        <div class="row">
            <div class="col col-6">
                <div class="form-group form-default">
                    <input type="text" name="nome" class="form-control" required pattern="[a-zA-Z0-9\.\-]{3,}"
        ...
        <div class="row">
            <div class="col col-6">
                <div class="form-group form-default">
                    <input type="text" name="tipo" class="form-control" required pattern="[a-zA-Z0-9\.\-]{3,20}"
                           title="Apenas caracteres de a à Z, 0 á 9 e de '.-' são permitidos.">
                    <span class="form-bar"></span>
        ...
        <div class="row">
            <div class="col col-6">
                <div class="form-group form-default">
                    <input type="text" name="grupo" class="form-control" required pattern="[a-zA-Z0-9\.\-]{3,}"
                           title="Apenas caracteres de a à z - 0 á 9 e de '.' são permitidos.">
                    <span class="form-bar"></span>
