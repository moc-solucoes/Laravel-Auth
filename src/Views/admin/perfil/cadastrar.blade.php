...
@section('breadcrumbs')
    ...
    <li class="breadcrumb-item">
        <a href="{{route('auth.admin.usuario.perfil.cadastrar')}}">Cadastrar Perfil</a>
    </li>
@endsection
...
@section('content')
    ...
    <form class="form-material" action="{{route('auth.admin.usuario.perfil.cadastrar')}}" method="post">
        @csrf
        <div class="row">
            <div class="col col-6">
                                        ...
                                        <div class="col-6">
                                            <div class="custom-control custom-checkbox checkbox-inline">
                                                <input type="checkbox" class="custom-control-input"
                                                       name="permissoes[]" value="{{$permission->id}}"
                                                       id="{{$permission->id}}">
