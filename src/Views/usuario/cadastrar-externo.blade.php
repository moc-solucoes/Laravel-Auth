@extends('shared.able-pro-externo')
            ...
            <form action="{{route('usuario.cadastrar')}}" method="post"
                ...
                <div class="auth-box card">
                    <div class="card-block">
                        ...
                        <div class="form-group form-primary">
                            <input type="email" name="email" class="form-control fill" required=""
                                   value="{{old("email")}}">
                            <span class="form-bar"></span>
                        ...
                        <div class="form-group form-primary">
                            <input type="text" name="celular" class="form-control fill celular"
                                   value="{{old("celular")}}">
                            <span class="form-bar"></span>
...
@section('js')
    <script type="text/javascript" src="{{asset('module/shared/js/mask-select2.js')}}"></script>
